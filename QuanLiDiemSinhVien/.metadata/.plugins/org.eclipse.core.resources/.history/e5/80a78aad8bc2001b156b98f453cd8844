...
public class GuiManager extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã Học Sinh", "Họ", "Tên", "Địa Chỉ", "Lớp"
            }
        ) {
        ...
        jTabbedPane2.addTab("Thông tin sinh viên", jPanel4);
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã Môn Học", "Tên Môn Học", "Số tín chỉ môn học"
            }
        ) {
            boolean[] canEdit = new boolean [] {
                false, true, false
        ...
        jTable4.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã Học Sinh", "Họ Và Tên", "Lớp", "Môn Học", "Điểm Trung Bình"
            }
        ) {
            boolean[] canEdit = new boolean [] {
    ...
    private void btnThemSvActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemSvActionPerformed
        ...
        try{
                   ...
                   txtDiachi.getText().equals(""))
            {
                ...
                {
                   HocSinh a = new HocSinh(txtMasv.getText(), cbLop.getSelectedItem().toString(),txtHo.getText(),txtTen.getText()
                        , txtDiachi.getText());
                   listSV.add(a);
                   ...
                   taoBangSV(); 
                    ...
                    JOptionPane.showMessageDialog(rootPane, "Mã Sinh Viên Này Tồn Tại");
                }
            }
        }
        catch(Exception e){
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
              ...
              {
                  JOptionPane.showMessageDialog(rootPane," Lá»—i nháº­p Ä‘iá»ƒm");
              }
              else
              {
            	  BangDiem a = new BangDiem(Integer.parseInt(txtDiem.getText())
                          ,returnHocSinh(jTextField1.getText()),
    ...
    HocSinh returnHocSinh(String b)
    {
